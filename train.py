...
from utils import Prediction_timed, time_sigmoid, time_score, score_scaled
...
def train(args, config):
    ...
    def evaluate(classifier, X_val,Y_val):
        ...
        fairness = evaluate_model_bias(model,"seatslog.txt")
        ...
        if search_metric == "custom":
            evaluation_dict[ACTIVE_METRIC_NAME] = accuracy * accuracy_wf + time_scores *time_wf +  robustness * robustness_wf  #+ min(1,0.1/(DSP_ForeignWorker + 1e-10)) * fairness_wf
